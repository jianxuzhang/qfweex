...
public class PerformanceMonitor {
    ...
    private static Performance filter(@NonNull WXPerformance rawPerformance) {
        ...
        p.callNativeTime = rawPerformance.fsCallNativeTotalTime;
        p.batchTime = rawPerformance.fsCallNativeTotalTime;
        p.updateDomObjTime = rawPerformance.fsCallNativeTotalTime;
        p.applyUpdateTime = rawPerformance.fsCallNativeTotalTime;
